...
func lexWhitespace(l *Lexer) stateFn {
	...
	case r == '"':
		return lexString
	case (r == '+' || r == '-') && !l.accept("0123456789"):
		//log.Println(r, l.pos-l.start, l.input[l.start:])
...
func lexNumber(l *Lexer) stateFn {
	//
	//if sign := l.peek(); (sign == '+' || sign == '-') && len(l.input) == 1 {
	//	return lexIdentifier
	//}
...
func isAlphaNumeric(r rune) bool {
	return r == '?' || r == ',' || r == '@' || r == '#' || r == '%' || r == '$' || r == '>' || r == '<' || r == '=' || r == '-' || r == '+' || r == '*' || r == '&' || r == '_' || r == '/' || unicode.IsLetter(r) || unicode.IsDigit(r)
}
